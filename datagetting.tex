...
Based on the sensors that we have available, we have choose types of motion capturing. We decided capture the movement of garment in two ways. We use both possibilities of Xtion sensor:	\begitems \style a
		* Standart RGB video camera captures a silhouette of the garment against the constant background when garment is moving {\bf perpendicular to the optical axis}.
		* Standart rangefinder captures the garment when garment is moving {\bf along the optical axis}.
	\enditems

...
Each of~arms "r1" and "r2" are ended with eletricly controlled grippers. (figure~\ref[fig:gripper]). Grippers are designed for~grasping of~garment.
\Green
\begitems \style o
* Rozvést
* Popsat prsty
...
\Green
\begitems \style o
	* Robot je vybaven řadou senzorů...
	* Popsat více senzorů (alespoň základně)
	* Pro řešení vybrat důležité
	* Nepoužívat camcorder
\enditems
\Black
...
\Green
\begitems \style o
	* Mírně zkrátit - odstranit příklady
\enditems
\Black
...
\Green
\begitems \style o
	* Rozvést co dělá rosbag tool, 14:45-16:10
\enditems
\Black
